...
DenseNet169 mimarisi ile sınıflandırma yapan eğitim betiği.

Bu dosya, ImageNet üzerinde ön-eğitimli (pretrained) DenseNet169 modelini
ince ayar (fine-tuning) yöntemiyle kullanır.
"""
